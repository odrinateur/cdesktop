...
//     --download-base "https://github.com/cdesktop-ai/cdesktop/releases/download/v0.2.0" \
//     --output latest.json
//
// The artifacts-dir should contain Tauri bundle outputs with .sig files:
//   tauri-artifacts/
//     darwin-aarch64/  -> cdesktop.app.tar.gz, cdesktop.app.tar.gz.sig
//     darwin-x86_64/   -> cdesktop.app.tar.gz, cdesktop.app.tar.gz.sig
//     linux-x86_64/    -> cdesktop.AppImage.tar.gz, cdesktop.AppImage.tar.gz.sig
//     windows-x86_64/  -> cdesktop-setup.exe, cdesktop-setup.exe.sig (NSIS)
//
