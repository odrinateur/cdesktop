...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::workspaces::execution::PackageScript::decl(),
        server::routes::workspaces::execution::PackageScriptsForRepo::decl(),
        server::routes::workspaces::execution::RunProjectScriptRequest::decl(),
        server::routes::workspaces::execution::RunProjectScriptError::decl(),
        server::routes::workspaces::execution::StopProjectScriptRequest::decl(),
