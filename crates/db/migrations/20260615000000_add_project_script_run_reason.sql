-- Add 'projectscript' to the execution_processes.run_reason CHECK constraint.
-- Used by scripts launched from the navbar (lint/build/dev/... read from
-- package.json), independently from the chat-level coding agents.
